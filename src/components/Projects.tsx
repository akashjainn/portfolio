export default function Projects() {
  const projects = [
    ...
    {
      title: "State Farm Chat Widget",
      description: "Scalable Angular chat system with AWS Lambda integration, reducing response latency by 35% and increasing engagement by 22%.",
      longDescription: "Enterprise-level chat solution with fault-tolerant architecture featuring persistent WebSockets, message delivery confirmation, and CDN-based fallback systems for optimal reliability and performance.",
      tech: ["Angular", "AWS Lambda", "WebSockets", "Amazon Connect", "TypeScript"],
      features: [
        "99.98% uptime across 2M+ monthly messages",
    ...
    },
    {
      ...
      description: "SQL-based inventory management system improving data accuracy and operational efficiency for medical supply tracking.",
      longDescription: "Comprehensive database solution for tracking thousands of medical supplies with real-time inventory updates, automated reorder alerts, and detailed reporting capabilities.",
