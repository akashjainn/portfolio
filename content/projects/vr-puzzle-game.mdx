...
<div className="not-prose my-8 w-full">
  <div className="relative w-full overflow-hidden rounded-lg border border-border/50 bg-muted/30" style={{ paddingBottom: '56.25%', backgroundColor: '#1a1a1a' }}>
    <iframe
      ...
      src="https://player.mux.com/rkpwWuwfgST6rnv8CJaEXL39fCP1yghNfNCWlN2NkG00"
      style={{ border: "none" }}
  ...
  <div className="text-sm text-muted-foreground mt-4 text-center">
    Experience the vine cutting mechanics and pattern recognition gameplay in real-time.
    <br />
