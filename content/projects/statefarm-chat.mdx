...
### Initial Welcome Screen, Conversation Flow & Session Management

The widget greets users with a clear system message about security and privacy, followed by the virtual assistant introduction. Users can ask questions naturally with guided responses and quick-action buttons. Sessions end gracefully with a confirmation dialog, with state preserved for transcript logging.
