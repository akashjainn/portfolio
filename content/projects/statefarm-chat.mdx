...
<div className="not-prose my-8 w-full" style={{ position: 'relative' }}>
  <div className="overflow-hidden rounded-lg border border-border/50" style={{ position: 'relative', width: '100%', aspectRatio: '16 / 9', backgroundColor: '#1a1a1a' }}>
    <iframe
