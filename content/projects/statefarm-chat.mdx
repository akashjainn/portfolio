...
<div className="not-prose my-8 w-full">
  <div className="relative w-full overflow-hidden rounded-lg border border-border/50 bg-muted/30" style={{ aspectRatio: '64/33', minHeight: '300px', backgroundColor: '#1a1a1a' }}>
    <iframe
