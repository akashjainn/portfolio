...
<Figure caption="FIG. 01 — Dashboard walkthrough, offline demo mode." meta="Oct 2025 · Mux stream">
  <div style={{ aspectRatio: '64 / 33', background: '#000', border: '1px solid var(--rule)' }}>
