...
<Figure caption="FIG. 01 — Dashboard walkthrough, offline demo mode." meta="Oct 2025 · Mux stream" aspectRatio="16 / 9">
  <div style={{ background: '#000', border: '1px solid var(--rule)', width: '100%', height: '100%', flex: 1 }}>
